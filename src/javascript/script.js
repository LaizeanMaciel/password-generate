function getChartTypes () {
    ...
    if (uppercase) {
        charTypes.push('ABCDEFGHIJKLMNOPQRSTUVWXZ')
    }
...
function getPasswordSize () {
    ...
    if (size < 4) {
        document.querySelector('#password_container').classList.add('hidden')
    } else {
        document.querySelector('#password_container').classList.remove('hidden')
    }
